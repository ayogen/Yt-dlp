...
object UrlNormalizer {
     ...
     * that yt-dlp extractors and page parsers natively understand.
     */
    suspend fun resolveCanonicalUrl(inputUrl: String): String {
        ...
        // 2. Short URLs, share URLs or redirect domains: follow the HTTP redirect chain to get the real canonical URL
        ...
        return try {
            ...
            try {
                val getRequest = Request.Builder()
                    ...
                    .get()
                    .build()
                client.executeAsync(getRequest).use { response ->
